...
console.log("bottom " + testResults.bottom().name())
console.log("pop " + testResults.pop().name())
console.log("shift " + testResults.shift().name())
console.log("unshift " + testResults.unshift().name())
console.log("cut " + testResults.cut().name())
